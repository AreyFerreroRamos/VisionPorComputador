function precision=ClassificarImatgesVersio2(name_folder, name_check_file)
    ...
    for num_image=3:length(folder)                                              % Es comença desde el tercer arxiu del directori, perquè el primer arxiu és el propi directori i el segon és el seu directori pare.
        ...
        ima_bin=~imbinarize(ima, 'adaptive', 'Sensitivity', 0.8);               % Es binaritza la imatge utilitzant un llindar local de 0'8.
